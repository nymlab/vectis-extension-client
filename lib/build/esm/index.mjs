...
export * from './types';
export async function getVectisForCosmos(url = `https://ipfs.io/ipfs/Qma4jV95Yp9NcTyEqXmMztL5kDC6gR3tiPRYR9q8UAaCv4`) {
    const iframe = document.querySelector(`.vectis-iframe`);
    if (iframe?.getAttribute('isReady'))
        return new VectisCosmosClient();
